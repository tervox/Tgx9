...
class MediaAdapter(
    ...
    override fun prepareActionMode(menu: Menu) {
        ...
        menu.apply {
            ...
            findItem(R.id.cab_open_multi_video).isVisible = !isOneItemSelected &&
                selectedItems.size in 2..4 &&
    ...
    override fun actionItemPressed(id: Int) {
        ...
        when (id) {
            ...
            R.id.cab_open_multi_video -> openMultiVideo()
...
//    override fun getItemKeyPosition(key: Int) = media.indexOfFirst { (it as? Medium)?.path?.hashCode() == key }
    ...
    private fun openMultiVideo() {
        val paths = getSelectedItems().filter { it.isVideo() }.map { it.path }
        if (paths.size < 2) return
        Intent(activity, com.goodwy.gallery.activities.MultiVideoActivity::class.java).apply {
            putStringArrayListExtra(com.goodwy.gallery.activities.MultiVideoActivity.EXTRA_PATHS, ArrayList(paths))
