...
class PhotoFragment : ViewPagerFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.apply {
            ...
            subsamplingView.setOnLongClickListener {
                val path = mMedium.path
                val ctx = context ?: return@setOnLongClickListener true
                val act = activity as? com.goodwy.commons.activities.BaseSimpleActivity ?: return@setOnLongClickListener true
                Thread {
                    try {
                        ...
                        recognizer.process(image)
                            .addOnSuccessListener { result ->
                                ...
                                act.runOnUiThread {
                                    if (text.isEmpty()) {
                                        act.toast(R.string.ocr_no_text)
                                    } else {
