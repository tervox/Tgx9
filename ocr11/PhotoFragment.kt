...
class PhotoFragment : ViewPagerFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.apply {
            ...
            subsamplingView.setOnLongClickListener { triggerOcr(); true }
            gesturesView.setOnClickListener { photoClicked() }
            gesturesView.setOnLongClickListener { triggerOcr(); true }
            ...
            gifView.setOnLongClickListener { triggerOcr(); true }
...
//    private fun getFilePathToShow() = if (mMedium.isPortrait()) mCurrentPortraitPhotoPath else getPathToLoad(mMedium)
    ...
    private fun triggerOcr() {
        ...
        val ctx = context ?: return
        val act = activity as? com.goodwy.commons.activities.BaseSimpleActivity ?: return
        Thread {
            try {
                ...
                recognizer.process(image)
                    .addOnSuccessListener { result ->
                        ...
                        act.runOnUiThread {
                            if (text.isEmpty()) act.toast(R.string.ocr_no_text)
                            else {
